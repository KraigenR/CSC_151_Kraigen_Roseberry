...
public class GeminiChatbot {
    ...
    public static void main(String[] args) {
        ...
        String apiKey = "AIzaSyA98kzSn3DG8P5SjLS3YSuyBeOwTpCT7xk"; // I had to pay for an API key as I ran out of free credits. Please replace this with your own API key if you plan on running this code past just a test. 
